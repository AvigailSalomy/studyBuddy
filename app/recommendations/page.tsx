  ...
  const [candidatesResult, ownMembershipsResult, ownPendingRequestsResult] =
    await Promise.all([
      ...
      supabase
        .from("groups")
        .select(
          "id, name, description, group_type, target_degree, target_year, location_or_link, max_members, owner_id, created_at, course:courses!inner(id, course_name, faculty, institution)",
        )
